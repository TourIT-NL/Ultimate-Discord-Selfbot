      ...
      >
        <div className="text-center space-y-4">
          ...
          <p className="text-xs text-m3-primary font-bold uppercase tracking-[0.8em] flex items-center justify-center gap-4 opacity-60">
            ...
            Privacy Enforcement Unit v1.0.4
            <span className="w-12 h-px bg-m3-primary/40" />
          </p>
        </div>
        <AnimatePresence mode="wait">
          ...
          {view === "auth" && (
            <LoginSelection
              ...
              rpcQrClientIdOverride={rpcQrClientIdOverride}
              setRpcQrClientIdOverride={setRpcQrClientIdOverride}
              handleSetRpcQrClientIdOverride={handleSetRpcQrClientIdOverride}
            />
          )}
          {view === "setup" && (
            <SetupView
