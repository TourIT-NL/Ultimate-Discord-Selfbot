    ...
    >
      {isComplete ? (
        ...
        <div className="w-full max-w-2xl flex flex-col items-center gap-16 px-10">
            ...
            <div className="w-full space-y-12 pt-10">
              ...
              <div className="w-full flex justify-center gap-4 mt-8">
                {operationStatus.is_paused ? (
                  <button
                    onClick={onResume}
                    className="m3-button-primary !bg-m3-secondary !text-m3-onSecondary"
                  >
                ...
                <button
                  onClick={onAbort}
                  className="m3-button-outlined !border-m3-error !text-m3-error"
                >
          ...
          <div className="mt-8">
            <a
              href="https://www.buymeacoffee.com/discordpurge"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="https://img.buymeacoffee.com/button-api/?text=Buy me a beer&emoji=🍺&slug=discordpurge&button_colour=FFDD00&font_colour=000000&font_family=Cookie&outline_colour=000000&coffee_colour=ffffff"
                alt="Buy Me A Beer"
              />
            </a>
          </div>
        ...
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="text-center space-y-4">
            <p className="text-xl font-black uppercase tracking-[0.8em] text-m3-primary animate-pulse italic leading-none">
              Synchronizing Protocol
            </p>
            <div className="flex items-center justify-center gap-3 opacity-40">
              <div className="w-12 h-px bg-m3-onSurface" />
              <p className="text-[10px] text-m3-onSurfaceVariant font-bold uppercase tracking-widest">
